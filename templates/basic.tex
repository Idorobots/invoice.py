...
\begin{center}
  ...
  \begin{tabular}{rlrrrrrr}
    \textbf{\#} & \textbf{title} & \multiline{\textbf{net price} \\ {[{{currency}}]}} & \textbf{qty.} & \multiline{\textbf{net amount} \\ {[{{currency}}]}} & \multiline{\textbf{VAT} \\ {[\%]}} & \multiline{\textbf{VAT} \\ {[{{currency}}]}} & \multiline{\textbf{amount} \\ {[{{currency}}]}} \\
    \hline
    {{#items}}
